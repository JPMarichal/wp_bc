 ...
 * Uso: docker exec -i wp_bc_cli wp eval-file scripts/tracking/init-db.php --allow-root
 */
...
echo "Total: {$res['total']} | Done: {$res['done']} | Pending_meta: {$res['pending_meta']} | Pending_translate: {$res['pending_translate']} (w/scr: {$res['translate_with_scr']}, no_scr: {$res['translate_no_scr']})\n";
