...
<div id="comments" class="bc-comments">
  ...
  if ( have_comments() ) :
    ...
    if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) :
      ...
      <nav id="comment-nav-above" class="bc-comment-navigation" role="navigation">
        <h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 've-theme' ); ?></h2>
        <div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 've-theme' ) ); ?></div>
        <div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 've-theme' ) ); ?></div>
      </nav>
    <?php endif; ?>
  ...
  if ( ! comments_open() && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
    ?>
    <p class="bc-no-comments"><?php esc_html_e( 'Comments are closed.', 've-theme' ); ?></p>
    <?php
  endif;
