...
<main id="main" class="bc-cat-archive">
  <div class="grid-container">
    <header class="bc-cat-archive-header">
      ...
      echo get_avatar( $author_id, 96, '', get_the_author_meta( 'display_name', $author_id ), array( 'class' => 'bc-author-avatar' ) );
      ?>
    ...
    <?php else : ?>
      <p class="bc-cat-empty">No se encontraron artículos de este autor.</p>
    <?php endif; ?>
  </div>
</main>
